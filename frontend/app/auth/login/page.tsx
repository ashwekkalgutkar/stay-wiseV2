...
export default function LoginPage() {
  ...
  <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-12">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Login or Create an Account</h2>
          ...
          <div className="mt-6 text-center text-base">
            New to StayWise? <a href="/auth/signup" className="text-orange-500 font-bold hover:underline">Sign up</a>
          </div>
        </div>
      </div>
    </div>
